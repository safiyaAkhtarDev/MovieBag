...
public class Constants {
    ...
    public static String URL_IMAGE_200 = "https://image.tmdb.org/t/p/w200";
    ...
    public static String getMovieProviderURL(int movieid) {
        return "https://api.themoviedb.org/3/movie/" + movieid + "/watch/providers?api_key=" + API_KEY + "&language=en-US";
    }
    ...
    public static String getWatchProviderURL(int movieid) {
